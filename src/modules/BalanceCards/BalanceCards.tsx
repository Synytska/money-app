...
export default async function BalanceCards() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <Card title="Paid invoices" value1={totalPaidInvoices} />
            <Card title="Unpaid invoices" value1={totalPendingInvoices} />
...
export function Card({ title, value1 }: ICards) {
    return (
        <div className="rounded-xl bg-icon_blue p-2 shadow-sm">
